...
namespace QLThuVien
{
    public partial class Timkiemtheoma : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void txtMaL_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            if (txtThanh.Text == "MÃ,TÊN NHÂN VIÊN")
            {
                s = "nv";
                searchTK.Text = "";
                Showgird();
            ...
            if (txtThanh.Text == "MÃ, TÊN LOẠI SÁCH")
            {
                s = "ls";
                searchTK.Text = "";
                Showgird();
            ...
            if (txtThanh.Text == "MÃ, TÊN ĐỘC GIẢ")
            {
                s = "dg";
                searchTK.Text = "";
                Showgird();
        ...
        private void txtThanh_SelectedIndexChanged(object sender, EventArgs e)
        {
