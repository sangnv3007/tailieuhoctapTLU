...
//lay ra chuyen muc con 
$sql ="select * from mvc_category where pid=$cid";

$children = select_list($sql);
//print_r($children);exit();

$listIds = "$cid";
if ($children) foreach($children as $cat){
	$listIds .= "," . $cat['id'];
}
//echo "listIds=[$listIds]"; exit();
$sqlProduct ="select * from mvc_product where cid in ($listIds)";
echo "sql=[$sqlProduct]"; exit();
//Thuc thi sql
...
<div class="wrapper" id="wrapper">
	<div class="header">
		...
		<ul class="header-menu">
			<?php $i = 0; $count = count($categories);?>
			<li class="first">
				<a href="#">Home</a>
			</li>
