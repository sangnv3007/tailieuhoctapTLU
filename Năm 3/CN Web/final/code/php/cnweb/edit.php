...
<div class="m-wrapper"><div class="travel-wrapper">
	...
	<div class="travel-content">
		<div class="travel-content-main">
			<h1>Sua tin bai</h1>
			<br/>
			<form class="form" action="edit_exec.php" method="post">
				<input type="hidden" name="id" value="<?php echo $result["id"]?>"/>
				<label>Category</label><input name="cid" value="<?php echo $result["cid"]?>"/>
				<div class="clear-both"></div>
				<label>Image</label><input name="img" value="<?php echo $result["img"]?>"/>
				<div class="clear-both"></div>
				...
				<div class="clear-both"></div>
				<label>Description</label><input name="description" value="<?php echo $result["description"]?>"/>
				<div class="clear-both"></div>
				<label>Body</label><textarea name="body"><?php echo $result["body"]?></textarea>
				<div class="clear-both"></div>
				<label>Status</label><input name="status" value="<?php echo $result["status"]?>"/>
				<div class="clear-both"></div>
				<button >OK</button>
			</form>
			<br/>
